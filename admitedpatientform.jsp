<%-- 
    ...
    Created on : Sep 22, 2018, 5:58:17 PM
    Author     : lenovo
--%>
...
<html>
    ...
    <form  action="patientcode.jsp" method="POST" style="margin-left: 500px;margin-top:30px;" onsubmit="return validation();">
        ...
        <table BGCOLOR="SKYBLUE" border="1" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <TD>
                        <input type="date" name="T10" value="" id="T10"/>
                    </TD>
                </tr>
                <TR>
                    <TD>
                    ...
                    <TD>
                        <input type="date" name="T11" id="T11" />
                    </TD>
                </TR>
                <TR>
                    <TD>
