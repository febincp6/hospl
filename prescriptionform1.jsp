<%-- 
    Document   : prescriptionform1
    Created on : Oct 24, 2018, 6:27:20 PM
    Author     : lenovo
--%>
    ...
    <center>
        <table  bgcolor="grey" border="0">
            ...
            <tbody>
                ...
                <tr>
                    <td>PATIENT NAME:</td>
                    <td><input type="text" name="T1" value="<%=rs.getString(3)%>"  placeholder="patient name" required /></td>
                </tr>
                <tr>
                    <td>
                        AGE:
                    ...
                    <td>
                        <input type="text" name="T2" value="<%=rs.getString(5)%>"/>
                    </td>
                </tr>
                <tr>
                    <td>
